...
const operationSubtract = document.getElementsById("operation-subtract");
const operationMultiply = document.getElementsById("operation-multiply");
const operationDivide = document.getElementsById("operation-divide");
...
operationSubtract.addEventListener("click", () => {
  calculatorSum = calculatorSum - operator;
  display.innerHTML = calculatorSum;
});
